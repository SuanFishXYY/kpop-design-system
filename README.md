...
> KPOP 女团圣人议会 · 186 idol · 52 团魂 · 7 评委 · 4 层议会架构 · 真投票引擎 · 哲学驱动多智能体 UI 设计语言体系
...
**?? [K-pop 议会 · 名单大全 (评委 + 团魂 + idol) →](./docs/MASTER-ROSTER.md)** — **7 评委 + 45 团魂 + 186 idol** 一份权威名单, 每个团展示集体宣言+全员
...
- ?? **bang-pd** ??? (HYBE) — LE SSERAFIM / ILLIT / KATSEYE
- ?? **mhj** ??? (ADOR) — NewJeans
- ?? **starship** ??? — IVE / WJSN / Kep1er
- ??? **teddy** Teddy Park — MEOVV / BP producer
